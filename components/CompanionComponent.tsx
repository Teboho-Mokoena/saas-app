            ...
            <section className="flex gap-8 max-sm:flex-col">
                <div className="companion-section">
                    ...
                    >
                        <div className={
                            cn(
                                'absolute transition-opacity duration-1000', callStatus === CallStatus.FINISHED ||
                ...
                <div className="user-section">
                    ...
                    <button
                        className={cn('rounded-lg py-2 ' +
                            'cursor-pointer transition-colors ' +
                            'w-full text-white', callStatus === CallStatus.ACTIVE ? 'bg-red-700' : 'bg-primary',
